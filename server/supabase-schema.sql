...
-- ============================================================
-- 19. OTP_CODES (persistent email verification codes)
-- ============================================================
-- Replaces the former in-memory OTP Map so codes survive server
-- restarts, cold starts, and multi-instance deployments.
...
DROP POLICY IF EXISTS "Allow all for authenticated" ON otp_codes;
CREATE POLICY "Allow all for authenticated" ON otp_codes FOR ALL USING (true) WITH CHECK (true);
