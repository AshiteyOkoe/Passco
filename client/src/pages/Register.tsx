...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen">
      <motion.div
        className="hidden flex-1 items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700 p-12 lg:flex"
      ...
      >
        ...
        >
          ...
          <p className="mt-2 text-blue-200">Create an account to access AI-powered quizzes and track your progress.</p>
          <motion.div
          ...
          >
            {['Take JHS assessments', 'Track your progress', 'Earn achievement badges'].map((feature) => (
              <motion.div key={feature} variants={fadeUp} className="flex items-center gap-2 text-blue-200">
      ...
      <motion.div
        className="flex flex-1 items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-8 dark:from-slate-950 dark:to-slate-900"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        >
          <motion.div className="mb-8 text-center" variants={fadeUp}>
            <motion.div
              className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/25"
          ...
          >
            ...
            <motion.div className="mb-4" variants={slideUp} custom={0}>
              ...
              <div className="relative">
                ...
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} required
                  className="w-full rounded-xl border border-slate-300 bg-white py-2.5 pl-10 pr-4 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
            ...
            <motion.div className="mb-4" variants={slideUp} custom={2}>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6}
                  className="w-full rounded-xl border border-slate-300 bg-white py-2.5 pl-10 pr-10 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
            ...
            <motion.div className="mb-4" variants={slideUp} custom={4}>
              ...
              <div className="flex gap-3">
                <button type="button" onClick={() => setGender('male')} className={cn('flex-1 rounded-xl border-2 px-4 py-2.5 text-sm font-medium transition', gender === 'male' ? 'border-blue-500 bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400' : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400')}>Male</button>
                <button type="button" onClick={() => setGender('female')} className={cn('flex-1 rounded-xl border-2 px-4 py-2.5 text-sm font-medium transition', gender === 'female' ? 'border-blue-500 bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400' : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-400')}>Female</button>
              </div>
            </motion.div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition hover:from-blue-600 hover:to-blue-700 disabled:opacity-50"
            >
